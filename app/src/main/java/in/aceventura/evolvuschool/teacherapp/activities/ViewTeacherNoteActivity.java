...
public class ViewTeacherNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_teacher_note);
        getId();
...
//        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(newdUrl+"AdminApi/" +"get_images_daily_notes", new JSONObject(params), new Response.Listener<JSONObject>() {
    ...
    public void onBackPressed() {
        Intent intent = new Intent(ViewTeacherNoteActivity.this, TeachersNoteACtivity.class);
        startActivity(intent);
        ViewTeacherNoteActivity.this.finish();
    }
    ...
    private void setView(final int i) {
        ...
        ImageView imgView1 = baseView.findViewById(R.id.imgView1);
      ...
      String imagename=meventImagesArrayList.get(i).getImgName();
        ...
        imgView1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent=new Intent(ViewTeacherNoteActivity.this,ViewFullSizeImage.class);
        ...
        imgView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(ViewTeacherNoteActivity.this, "Downloading  "+imageName.getText().toString(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        txtpdfname.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view) {
               ...
               String fName=txtpdfname.getText().toString();
                ...
                Toast.makeText(ViewTeacherNoteActivity.this, "Downloading to Downloads Folder "+fName, Toast.LENGTH_LONG).show();
            }
        });
...
//                downloadUrl = prourl+"uploads/" +name + "/daily_notes/"+dateImage+"/"+sectionid +"/"+fName;
    ...
    private void requestStoragePermission() {
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
            ...
            Toast.makeText(ViewTeacherNoteActivity.this, "To Download Notice Attachment Please Allow the Storage Permission", Toast.LENGTH_LONG).show();
        }
